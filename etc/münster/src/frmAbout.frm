...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label Label1 
      Caption         =   "(c) Das Fuchslogo stammt von Reiner Stolte, München"
      Height          =   255
      Left            =   240
      TabIndex        =   9
      Top             =   3600
   ...
   Begin VB.Image Fuchslogo 
      ...
      Width           =   1620
   End
   Begin VB.Image schloss 
      Height          =   975
      Left            =   1680
      Picture         =   "frmAbout.frx":4289
      Top             =   1440
      Width           =   2250
   End
   Begin VB.Label lblDisclaimer 
      Caption         =   "Westfälische Wilhelms-Universität Münster"
      ForeColor       =   &H00000000&
      Height          =   225
      Index           =   3
      Left            =   480
   ...
   End
   Begin VB.Label lblDisclaimer 
      Caption         =   "Physikalisches Institut"
      ForeColor       =   &H00000000&
      Height          =   225
      Index           =   1
      Left            =   480
   ...
   End
   Begin VB.Label lblDisclaimer 
      Caption         =   "(c) Arbeitsgruppe Prof. Harald Fuchs"
      ForeColor       =   &H00000000&
      Height          =   225
      Index           =   0
      Left            =   255
