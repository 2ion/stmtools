...
#define DEVICE_NAME ("stmDeviceTemplate")
#define DEVICE_AUTHOR ("joj")
#define DEVICE_VERSION ("10-2010.2")
#define DEVICE_DESCR ("Template for dynamically loaded device plugins.")
...
Q_EXPORT_PLUGIN2(stmDeviceTemplate,stmDevice);
